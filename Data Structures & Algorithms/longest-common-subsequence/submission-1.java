class Solution {
    ...
    public int lcs(String text1, String text2, int i1, int i2, int[][] dp){
        ...
        if(text1.charAt(i1)==text2.charAt(i2)) return dp[i1][i2] = 1 + lcs(text1,text2,i1-1,i2-1,dp);

        return dp[i1][i2] = Math.max(lcs(text1,text2,i1-1,i2,dp) , lcs(text1,text2,i1,i2-1,dp));
    }
}
